...
Separado de ``IngestionErrorCode`` (dominio) para mantener
clara la separación de responsabilidades:

- ``IngestionErrorCode`` → errores de reglas de negocio del dominio
...
class ApplicationErrorCode(str, Enum):
    ...
    Diferentes de IngestionErrorCode (dominio). Representan
