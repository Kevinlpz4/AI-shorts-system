...
NO incluye:
    - LearningDomainError (dominio) — violaciones de reglas de negocio
    - InfrastructureError — fallos técnicos (DB, red)

Uso::

    from learning.application.exceptions import CommandValidationError

    raise CommandValidationError("Field 'source_name' is required")
"""
